...
use crate::proto::chalk::server::v1::deploy_service_server::DeployService;
use crate::proto::chalk::server::v1::{
    DeploymentStatus, ListDeploymentsRequest, ListDeploymentsResponse,
    Deployment, GetDeploymentRequest, GetDeploymentResponse, GetActiveDeploymentsRequest,
    GetActiveDeploymentsResponse, DeployBranchRequest, DeployBranchResponse,
    CreateBranchFromSourceDeploymentRequest, CreateBranchFromSourceDeploymentResponse,
    SuspendDeploymentRequest, SuspendDeploymentResponse, ScaleDeploymentRequest,
    ScaleDeploymentResponse, TagDeploymentRequest, TagDeploymentResponse
};
...
fn generate_mock_deployment(id: &str) -> Deployment {
    ...
    Deployment {
        ...
        status: DeploymentStatus::DeploymentStatusSuccess as i32,
...
fn generate_mock_active_deployments(count: usize) -> Vec<Deployment> {
    (0..count)
        .map(|i| {
            ...
            deployment.status = DeploymentStatus::DeploymentStatusSuccess as i32;
            deployment
        })
        .collect()
}